...
WEIGHT_DECAY = 0*0.00001   # L2 weight decay
UPDATE_EVERY = 5
max_score = 30
...
class Agent():
    ...
    def act(self, state, current_score, add_noise=True):
    ...
    def learn(self, experiences, gamma):
        ...
        # ---------------------------- update local actor and local critic ---------------------------- #
        # Compute actor loss
        actions_pred = self.actor_local(states)
        actor_loss = -self.critic_local(states, actions_pred).mean() #POURQUOI LOCAL ?
